    ...
    return (
        ...
        >
            <div className="container relative">
                ...
                <div className="relative max-[23rem] mx-auto md:max-w-5-xl xl:mb-24">
                    <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
                        <div className="relative bg-n-8 rounded-[1rem]">
                            <div className="h-[1.4rem] bg-n-10 rounded-t-[0.9rem]" />
                            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[10224/490]" >
                                <img
                                    src={robot}
                                    className="w-full"
                                    width={1440}
